...
/* Do a hare-clarke scrutiny, until the candidate `vacating' reaches
...
/* return true if vacancy_flag is set. i.e. actual cas vac counts are underway */
bool is_vacancy(void);

/* set and reset vacancy_flag */
