...
extern void create_paper_table(PGconn *conn);
extern void create_entry_table(PGconn *conn);
...
extern void create_confirmed_vote_table(PGconn *conn);
extern void create_confirmed_preference_table(PGconn *conn);
extern void create_electorate_preference_tables(PGconn *conn);
